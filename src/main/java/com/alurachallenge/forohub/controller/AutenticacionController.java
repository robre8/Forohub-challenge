...
import com.alurachallenge.forohub.infra.security.DatosJTWToken;
...
public class AutenticacionController {
    ...
    public ResponseEntity autenticarUsuario(@RequestBody @Valid DatosAutenticacionUsuario datosAutenticacionUsuario){
        ...
        var JTWToken = tokenService.generarToken((Usuario) usuarioAutenticado.getPrincipal());
        return ResponseEntity.ok(new DatosJTWToken(JTWToken));
